      ...
      <div>
        <label className="w-[3rem] flex items-center bg-gray rounded-[10px]">
          <input
            ...
            id="togglebox"
          />
          <span className="w-6 h-6 flex items-center rounded-[50%] duration-300 ease-in-out cursor-pointer after:w-6 after:h-6 after:bg-black after:rounded-[50%] after:shadow-md after:duration-300 peer-checked:after:translate-x-6" />
        </label>
      </div>
